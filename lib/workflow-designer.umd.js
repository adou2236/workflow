...
(function(global2, factory) {
  ...
  const _hoisted_2 = { class: "node-notification" };
  const _hoisted_3 = { class: "node-description" };
  const _hoisted_4 = ["title"];
  const _hoisted_5 = { "data-test-id": "canvas-node-box-title" };
  const _hoisted_6 = /* @__PURE__ */ vue.createElementVNode("div", { class: "node-anchor node-anchor__top" }, null, -1);
  const _hoisted_7 = /* @__PURE__ */ vue.createElementVNode("div", { class: "node-anchor node-anchor__right" }, null, -1);
  const _hoisted_8 = /* @__PURE__ */ vue.createElementVNode("div", { class: "node-anchor node-anchor__bottom" }, null, -1);
  const _hoisted_9 = /* @__PURE__ */ vue.createElementVNode("div", { class: "node-anchor node-anchor__left" }, null, -1);
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: emits }) {
      ...
      function isActive() {
        ...
        return vue.unref(currentSelect).id === currentNode.id;
      }
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          onContextmenu: _cache[0] || (_cache[0] = vue.withModifiers(($event) => showNodeContextMenu(__props.node), ["stop"])),
          onDblclick: setNodeParams
        }, [
          ...
          vue.createElementVNode("div", _hoisted_3, [
            vue.createElementVNode("div", {
              ...
              vue.createElementVNode("p", _hoisted_5, vue.toDisplayString(__props.node.displayName), 1)
            ], 8, _hoisted_4)
          ]),
          _hoisted_6,
          _hoisted_7,
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      function initJsPlumb() {
        ...
        vue.unref(plumb).bind("connection", (conn) => {
          ...
          (_a = document.querySelector("#" + id)) == null ? void 0 : _a.addEventListener("contextmenu", (e) => {
            showLinkContextMenu(e);
            currentSelect.value = flowData.value.linkList.find((l) => l.id === id);
          });
          (_b = document.querySelector("#" + id)) == null ? void 0 : _b.addEventListener("click", (e) => {
            e.stopPropagation();
            currentSelect.value = flowData.value.linkList.find((l) => l.id === id);
          });
          ...
          vue.createElementVNode("div", {
            ...
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(flowData).nodeList, (node) => {
              return vue.openBlock(), vue.createBlock(_sfc_main$2, {
                ...
                onSetNodeParams: _cache[1] || (_cache[1] = (v) => emits("setNodeParams", v)),
                onAlignForLine: alignForLine,
                onHideAlignLine: hideAlignLine
              }, null, 8, ["node", "plumb", "config", "select"]);
            }), 128))
          ], 38)
        ], 36);
      };
