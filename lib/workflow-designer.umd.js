...
(function(global2, factory) {
  ...
  const _hoisted_3 = { class: "node-setting" };
  const _hoisted_4 = { class: "node-icon" };
  const _hoisted_5 = { class: "node-description" };
  const _hoisted_6 = ["title"];
  const _hoisted_7 = { "data-test-id": "canvas-node-box-title" };
  ...
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: emits }) {
      ...
      vue.watch(() => props2.select, (val) => {
        currentSelect.value = val;
      }, { deep: true });
      vue.watch(() => currentSelect.value, (currentSelect2) => {
        emits("update:select", currentSelect2);
      });
      vue.watch(() => props2.selectGroup, (val) => {
        currentSelectGroup.value = val;
      });
      vue.watch(() => currentSelectGroup.value, (currentSelectGroup2) => {
        emits("update:selectGroup", currentSelectGroup2);
      });
      vue.watch(() => props2.plumb, (v) => {
        if (v) {
          vue.nextTick(() => {
            registerNode();
          });
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          vue.createElementVNode("div", _hoisted_4, [
            (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(__props.node.icon)))
          ]),
          vue.createElementVNode("div", _hoisted_5, [
            vue.createElementVNode("div", {
              ...
              vue.createElementVNode("p", _hoisted_7, vue.toDisplayString(__props.node.displayName), 1),
              __props.node.disabled ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_8, "(\u7981\u7528)")) : vue.createCommentVNode("", true)
            ], 8, _hoisted_6)
          ])
        ], 46, _hoisted_1$1);
      };
  ...
  (function(exports3) {
          ...
          _each(el, function() {
            ...
            var eventGenerators = {
              ...
              "MouseEvents": function(evt2) {
                evt2.initMouseEvent(eventToBind, true, true, window, 0, sl[0], sl[1], cl[0], cl[1], false, false, false, false, 1, _el);
              }
            };
    ...
    (function() {
      ...
      {
        exports3.Katavorio = root.Katavorio;
      }
    }).call(typeof window !== "undefined" ? window : commonjsGlobal);
    (function() {
      var root = this;
        ...
        var _amEndpoints = {}, continuousAnchorLocations = {}, continuousAnchorOrientations = {}, connectionsByElementId = {}, self2 = this, anchorLists = {}, jsPlumbInstance = params.jsPlumbInstance, floatingConnections = {}, placeAnchorsOnLine = function(desc, elementDimensions, elementPosition, connections, horizontal, otherMultiplier, reverse, rotation) {
          ...
          var cd = jsPlumbInstance.getCachedData(elementId), sS = cd.s, sO = cd.o, placeSomeAnchors = function(desc, elementDimensions, elementPosition, unsortedConnections, isHorizontal, otherMultiplier, orientation) {
            if (unsortedConnections.length > 0) {
              var sc = _sortHelper(unsortedConnections, edgeSortFunctions[desc]), reverse = desc === "right" || desc === "top", rotation = jsPlumbInstance.getRotation(elementId), anchors = placeAnchorsOnLine(desc, elementDimensions, elementPosition, sc, isHorizontal, otherMultiplier, reverse, rotation);
    ...
    (function() {
      ...
      var StateMachine = function(params) {
        ...
        this._computeBezier = function(paintInfo, params2, sp, tp, w, h) {
          ...
          _controlPoint = _findControlPoint(_midx, _midy, segment, params2.sourcePos, params2.targetPos, curviness, curviness, distance, proximityLimit);
  ...
  const _hoisted_1 = { class: "flow-area__scale" };
  const _sfc_main = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const flowConfig$1 = vue.reactive(props2.config || flowConfig);
      ...
      const container = vue.reactive({
        ...
        dragFlag: false,
        draging: false,
        scale: flowConfig$1.defaultStyle.containerScale.init,
        scaleFlag: false,
        scaleOrigin: {
          x: 0,
          y: 0
        },
        scaleShow: utils.mul(flowConfig$1.defaultStyle.containerScale.init, 100),
        auxiliaryLine: {
          isOpen: flowConfig$1.defaultStyle.isOpenAuxiliaryLine,
          isShowXLine: false,
          isShowYLine: false,
      ...
      function computeNodePos(x, y) {
        const pxx = flowConfig$1.defaultStyle.alignGridPX[0];
        const pxy = flowConfig$1.defaultStyle.alignGridPX[1];
        if (x % pxx)
          x = pxx - x % pxx + x;
        if (y % pxy)
          y = pxy - y % pxy + y;
      ...
      function enlargeContainer() {
        ...
        let newScale = utils.add(container.scale, flowConfig$1.defaultStyle.containerScale.onceEnlarge);
        if (newScale <= flowConfig$1.defaultStyle.containerScale.max) {
      ...
      function narrowContainer() {
        container.scaleOrigin.x = mouse.position.x;
        container.scaleOrigin.y = mouse.position.y;
        let newScale = utils.sub(container.scale, flowConfig$1.defaultStyle.containerScale.onceNarrow);
        if (newScale >= flowConfig$1.defaultStyle.containerScale.min) {
          container.scale = newScale;
          container.scaleShow = utils.mul(container.scale, 100);
          plumb.value.setZoom(container.scale);
        }
      ...
      function flowInfo() {
        ...
        console.info("\u5F53\u524D\u6D41\u7A0B\u56FE\u4E2D\u6709 " + nodeList.length + " \u4E2A\u8282\u70B9\uFF0C\u6709 " + linkList.length + " \u6761\u8FDE\u7EBF\u3002");
      }
      function paste() {
        let dis = 0;
        ...
        if (container.auxiliaryLine.controlFnTimesFlag) {
          ...
          nodeList.forEach((node) => {
            if (elId !== node.id) {
              ...
              let dis = flowConfig$1.defaultStyle.showAuxiliaryLineDistance, elPos = e.pos, elH = e.el.offsetHeight, elW = e.el.offsetWidth, disX = elPos[0] - node.x, disY = elPos[1] - node.y;
      ...
      function dataInit() {
        ...
        if (flowData.value.linkList.length > 0) {
          flowData.value.linkList.forEach((item) => {
            __addLink(plumb.value, { id: item.sourceId, endpoint: item.sourceEndpoint }, { id: item.targetId, endpoint: item.targetEndpoint }, { id: item.id, label: item.label });
          });
        }
      ...
      function deleteLink() {
        ...
        vue.unref(plumb).deleteConnection(vue.unref(plumb).getConnections({
          source: sourceId,
          target: targetId
        })[0]);
        let linkList = vue.unref(flowData).linkList;
      ...
      vue.watch(() => currentSelect.value, (val) => {
      ...
      vue.watch(() => currentSelectGroup.value, (val) => {
        emits("update:selectGroup", val);
      }, { deep: true });
      vue.watch(() => props2.readOnly, (v) => {
      });
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          vue.createElementVNode("div", {
            ...
            class: vue.normalizeClass(["flow-area__container", {
              grid: flowData.value.config.showGrid,
            ...
            rectangleMultiple.flag && rectangleMultiple.multipling ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 0,
          ...
          vue.createElementVNode("div", _hoisted_1, [
            ...
            vue.createElementVNode("span", null, vue.toDisplayString(container.scaleShow) + "% ", 1),
            vue.createVNode(_component_el_button, {
              size: "small",
              type: "default",
              onClick: enlargeContainer
            }, {
              icon: vue.withCtx(() => [
                vue.createVNode(_component_el_icon, null, {
                  default: vue.withCtx(() => [
