  ...
  const _sfc_main = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const container = vue.reactive({
        ...
        scaleShow: utils.mul(flowConfig$1.value.defaultStyle.containerScale.init, 100),
        auxiliaryLine: {
      ...
      function enlargeContainer() {
        ...
        let newScale = utils.add(
          container.scale,
          flowConfig$1.value.defaultStyle.containerScale.onceEnlarge
        );
        if (newScale <= flowConfig$1.value.defaultStyle.containerScale.max) {
      ...
      function narrowContainer() {
        ...
        let newScale = utils.sub(
          container.scale,
          flowConfig$1.value.defaultStyle.containerScale.onceNarrow
        );
        if (newScale >= flowConfig$1.value.defaultStyle.containerScale.min) {
          container.scale = newScale;
          container.scaleShow = utils.mul(container.scale, 100);
          plumb.value.setZoom(container.scale);
        }
