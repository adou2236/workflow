...
(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.index = {}, global2.Vue));
  ...
  var CommonNodeTypeEnum = /* @__PURE__ */ ((CommonNodeTypeEnum2) => {
    CommonNodeTypeEnum2["COMMON"] = "common";
    CommonNodeTypeEnum2["NOTE"] = "note";
    return CommonNodeTypeEnum2;
  })(CommonNodeTypeEnum || {});
  var FlowStatusEnum = /* @__PURE__ */ ((FlowStatusEnum2) => {
    FlowStatusEnum2["CREATE"] = "0";
    FlowStatusEnum2["SAVE"] = "1";
    FlowStatusEnum2["MODIFY"] = "2";
    FlowStatusEnum2["LOADING"] = "3";
    return FlowStatusEnum2;
  })(FlowStatusEnum || {});
  var IdTypeEnum = /* @__PURE__ */ ((IdTypeEnum2) => {
    IdTypeEnum2["UUID"] = "uuid";
    IdTypeEnum2["TIME_STAMP"] = "time_stamp";
    IdTypeEnum2["SEQUENCE"] = "sequence";
    IdTypeEnum2["TIME_STAMP_AND_SEQUENCE"] = "time_stamp_and_sequence";
    IdTypeEnum2["CUSTOM"] = "custom";
    return IdTypeEnum2;
  })(IdTypeEnum || {});
  var FLOW_TYPE = /* @__PURE__ */ ((FLOW_TYPE2) => {
    FLOW_TYPE2["TRIGGER"] = "trigger";
    FLOW_TYPE2["ACTION"] = "action";
    return FLOW_TYPE2;
  })(FLOW_TYPE || {});
  const variable = {
    "primary-color": "var(--el-color-primary)",
    "rect-color": "var(--el-text-color-regular)"
  };
  const settingConfig = {
    containerScale: {
      onceNarrow: 0.1,
  ...
  const utils = {
    ...
    getId: function() {
      const idType$1 = idType;
      if (typeof idType$1 === "string") {
        if (idType$1 === IdTypeEnum.UUID) {
          return this.getUUID();
        } else if (idType$1 === IdTypeEnum.TIME_STAMP) {
          return this.getTimeStamp();
        }
      } else if (idType$1 instanceof Array) {
        if (idType$1[0] === IdTypeEnum.SEQUENCE) {
          return this.getSequence(idType$1[1]);
        } else if (idType$1[0] === IdTypeEnum.TIME_STAMP_AND_SEQUENCE) {
          return this.getTimeStampAndSequence(idType$1[1]);
        } else if (idType$1[0] === IdTypeEnum.CUSTOM) {
          return idType$1[1]();
        }
      }
    },
  ...
  function getZoomToFit(nodeList) {
    ...
    let xOffset = minX * -1 * zoomLevel;
    xOffset += (editorWidth - (maxX - minX) * zoomLevel) / 2;
    let yOffset = minY * -1 * zoomLevel;
    yOffset += (editorHeight - (maxY - minY) * zoomLevel) / 2;
    return {
      zoomLevel,
  ...
  const closestNumberDivisibleBy = (inputNumber, divisibleBy) => {
  ...
  }, _hoisted_2282 = /* @__PURE__ */ vue.createElementVNode(
    "path",
    {
      fill: "currentColor",
  ...
  const _hoisted_2 = { class: "node-tools" };
  const _hoisted_3 = { class: "node-notification" };
  const _hoisted_4 = { class: "node-setting" };
  const _hoisted_5 = /* @__PURE__ */ vue.createElementVNode("img", {
    class: "node-icon",
    src: "http://dummyimage.com/100x100"
  }, null, -1);
  const _hoisted_6 = { class: "node-description" };
  const _hoisted_7 = ["title"];
  const _hoisted_8 = { "data-test-id": "canvas-node-box-title" };
  ...
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: emits }) {
      ...
      const flowConfig2 = vue.reactive(props2.config);
      const currentNode = vue.reactive(props2.node);
      const currentSelect = vue.ref(props2.select);
      const currentSelectGroup = vue.ref(props2.selectGroup);
      const nodeRef = vue.ref();
      const message = vue.ref("");
      const status = vue.ref("");
      const IconMap = vue.ref({
        info: "InfoFilled",
      ...
      function registerNode() {
        props2.plumb.draggable(currentNode.id, {
          containment: "parent",
          handle: (e, el) => {
            var _a, _b, _c;
            let possibles = (_b = (_a = el == null ? void 0 : el.parentNode) == null ? void 0 : _a.querySelectorAll(".node-box")) != null ? _b : [];
            for (let i = 0; i < (possibles == null ? void 0 : possibles.length); i++) {
              if (possibles[i] === el || ((_c = e == null ? void 0 : e.target) == null ? void 0 : _c.className) === "lane-text")
                return true;
            }
            return false;
          },
          grid: flowConfig2.defaultStyle.alignGridPX,
          drag: (e) => {
            if (flowConfig2.defaultStyle.isOpenAuxiliaryLine) {
      ...
      function isActive() {
        if (!vue.unref(currentSelect)) {
          return false;
        }
        if (vue.unref(currentSelect).id === currentNode.id)
          return true;
        let f = vue.unref(currentSelectGroup).find((n) => n.id === currentNode.id);
        return !!f;
      }
      ...
      vue.watch(
        () => currentSelect.value,
        (currentSelect2) => {
          emits("update:select", currentSelect2);
        }
      );
      vue.watch(
        () => props2.selectGroup,
      ...
      vue.watch(
        () => currentSelectGroup.value,
        (currentSelectGroup2) => {
          emits("update:selectGroup", currentSelectGroup2);
        }
      );
      vue.watch(
        () => props2.plumb,
      ...
      vue.onMounted(() => {
        ...
        (_a = observer.value) == null ? void 0 : _a.observe(nodeRef.value, { attributes: true });
      });
      vue.onBeforeUnmount(() => {
        var _a;
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          ref_key: "nodeRef",
          ref: nodeRef,
          class: vue.normalizeClass(["node-box", [
            {
              disabled: __props.node.disabled,
              active: isActive()
            },
            __props.node.flowType
          ]]),
          style: vue.normalizeStyle({
            top: __props.node.y + "px",
            left: __props.node.x + "px",
            cursor: "move"
          }),
          onClick: vue.withModifiers(selectNode, ["stop"]),
          onContextmenu: _cache[3] || (_cache[3] = vue.withModifiers(($event) => showNodeContextMenu(__props.node), ["stop"]))
        }, [
          vue.createElementVNode("div", _hoisted_2, [
            vue.createVNode(_component_el_icon, {
              onClick: _cache[0] || (_cache[0] = ($event) => handleDisable(__props.node))
            }, {
              default: vue.withCtx(() => [
                __props.node.disabled ? (vue.openBlock(), vue.createBlock(vue.unref(video_play_default), { key: 0 })) : (vue.openBlock(), vue.createBlock(_component_VideoPause, { key: 1 }))
              ]),
              _: 1
            }),
            vue.createVNode(_component_el_icon, {
              onClick: _cache[1] || (_cache[1] = ($event) => handleDelete(__props.node))
            }, {
              default: vue.withCtx(() => [
          ...
          vue.withDirectives(vue.createElementVNode("div", _hoisted_3, [
            vue.createVNode(_component_el_tooltip, { content: message.value }, {
              default: vue.withCtx(() => [
                vue.createVNode(_component_el_icon, {
                  color: `var(--el-color-${status.value})`
                }, {
                  default: vue.withCtx(() => [
                    (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(IconMap.value[status.value])))
                  ]),
                  _: 1
                }, 8, ["color"])
              ]),
          ...
          vue.createElementVNode("div", _hoisted_4, [
            vue.createVNode(_component_el_icon, {
              onClick: _cache[2] || (_cache[2] = ($event) => setNodeParams(__props.node))
            }, {
              default: vue.withCtx(() => [
          ...
          vue.createElementVNode("div", _hoisted_6, [
            vue.createElementVNode("div", {
              class: "node-name",
              title: __props.node.displayName
            }, [
              vue.createElementVNode("p", _hoisted_8, vue.toDisplayString(__props.node.displayName), 1),
              __props.node.disabled ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_9, "(\u7981\u7528)")) : vue.createCommentVNode("", true)
            ], 8, _hoisted_7)
          ])
        ], 46, _hoisted_1);
      };
      ...
      function renderMenuItem(items) {
        ...
        return visibleItems.map((item) => {
          ...
          if (!children || children.length === 0) {
            return vue.createVNode(vue.Fragment, null, [vue.createVNode(vue.resolveComponent("el-menu-item"), {
              "disabled": disabled,
              "class": `${prefixCls}__item`,
              "key": label
            }, {
              default: () => [vue.createVNode(ItemContent, contentProps, null)]
            }), divider ? vue.createVNode(vue.resolveComponent("el-divider"), {
              "key": `d-${label}`
            }, null) : null]);
          }
  ...
  const createContextMenu = function(options) {
    const { event: event2 } = options || {};
    event2 && (event2 == null ? void 0 : event2.preventDefault());
    ...
    return new Promise((resolve) => {
      ...
      if (options.event) {
        propsData.customEvent = event2;
        propsData.axis = { x: event2.clientX, y: event2.clientY };
      }
      const vm = vue.createVNode(_sfc_main$1, propsData);
  ...
  (function(exports3) {
    ...
    (function() {
      ...
      var root2 = this, matchesSelector = function(el, selector, ctx) {
        ...
        if (i < l.length)
          l.splice(i, 1);
      }, guid = 1, _store = function(obj, event2, fn) {
        var g = guid++;
        obj.__ta = obj.__ta || {};
        ...
        fn.__tauid = g;
        return g;
      }, _unstore = function(obj, event2, fn) {
      ...
      root2.Mottle = function(params) {
        ...
        this.on = function(el, event2, children, fn) {
          var _el = arguments[0], _c = arguments.length == 4 ? arguments[2] : null, _e = arguments[1], _f = arguments[arguments.length - 1];
          _doBind(_el, _e, _f, _c);
          return this;
        };
        this.off = function(el, event2, fn) {
          _unbind(el, event2, fn);
          return this;
        };
        this.trigger = function(el, event2, originalEvent, payload) {
          var originalIsMouse = isMouseDevice && (typeof MouseEvent === "undefined" || originalEvent == null || originalEvent.constructor === MouseEvent);
          var eventToBind = isTouchDevice && !isMouseDevice && touchMap[event2] ? touchMap[event2] : event2, bindingAMouseEvent = !(isTouchDevice && !isMouseDevice && touchMap[event2]);
          ...
          _each(el, function() {
            ...
            if (document.createEvent) {
              var ite = !bindingAMouseEvent && !originalIsMouse && (isTouchDevice && touchMap[event2]), evtName = ite ? "TouchEvent" : "MouseEvents";
    ...
    (function() {
      ...
      var Drop = function(el, params, css, scope) {
        ...
        this.drop = function(drag, event2) {
          return this.params.events["drop"]({ drag, e: event2, drop: this });
        };
        this.destroy = function() {
          this._class = null;
      ...
      root2.Katavorio = function(katavorioParams) {
        ...
        this.unmarkSelection = function(drag, event2) {
          _foreach(_selection, function(e) {
            e.unmark(event2);
          }, drag);
        };
        this.unmarkPosses = function(drag, event2) {
          if (drag.posses) {
            _each(drag.posses, function(p) {
              if (drag.posseRoles[p] && _posses[p]) {
                _foreach(_posses[p].members, function(d) {
                  d.unmark(event2, true);
                }, drag);
              }
            });
          }
      ...
      {
        exports3.Katavorio = root2.Katavorio;
      }
    }).call(typeof window !== "undefined" ? window : commonjsGlobal);
    (function() {
      var root2 = this;
      ...
      {
        exports3.jsPlumbUtil = jsPlumbUtil2;
      }
      function isArray(a) {
        return Object.prototype.toString.call(a) === "[object Array]";
      }
      ...
      jsPlumbUtil2.isObject = isObject2;
      function isDate(o) {
      ...
      var EventGenerator = function() {
        function EventGenerator2() {
          ...
          this.queue = [];
          this.bind = function(event2, listener, insertAtStart) {
            ...
            if (typeof event2 === "string") {
              _one(event2);
            } else if (event2.length != null) {
              for (var i2 = 0; i2 < event2.length; i2++) {
                _one(event2[i2]);
              }
            }
            return _this;
          };
          this.fire = function(event2, value, originalEvent) {
            if (!this.tick) {
              this.tick = true;
              if (!this.eventsSuspended && this._listeners[event2]) {
                var l = this._listeners[event2].length, i2 = 0, _gone = false, ret = null;
                if (!this.shouldFireEvent || this.shouldFireEvent(event2, value, originalEvent)) {
                  while (!_gone && i2 < l && ret !== false) {
                    if (this.eventsToDieOn[event2]) {
                      this._listeners[event2][i2].apply(this, [value, originalEvent]);
                    } else {
                      try {
                        ret = this._listeners[event2][i2].apply(this, [value, originalEvent]);
                      } catch (e) {
                        log("jsPlumb: fire failed for event " + event2 + " : " + e);
                      }
                    }
                    i2++;
    ...
    (function() {
      var root2 = this;
      root2.jsPlumbUtil.matchesSelector = function(el, selector, ctx) {
        ctx = ctx || el.parentNode;
        var possibles = ctx.querySelectorAll(selector);
        for (var i = 0; i < possibles.length; i++) {
          if (possibles[i] === el) {
    ...
    (function() {
      var DEFAULT_OPTIONS = {
        deriveAnchor: function(edge, index2, ep, conn) {
          return {
      ...
      var List = function(instance, el, options, id) {
        el["_jsPlumbList"] = id;
        function deriveAnchor(edge, index2, ep, conn) {
          return options.anchor ? options.anchor : options.deriveAnchor(edge, index2, ep, conn);
        }
        function deriveEndpoint(edge, index2, ep, conn) {
          return options.deriveEndpoint ? options.deriveEndpoint(edge, index2, ep, conn) : options.endpoint ? options.endpoint : ep.type;
        }
    ...
    (function() {
      ...
      var _ju = root2.jsPlumbUtil, _updateHoverStyle = function(component) {
        ...
        var self2 = this, a = arguments, idPrefix = self2.idPrefix, id = idPrefix + new Date().getTime();
        this._jsPlumb = {
        ...
        if (params.events) {
          for (var evtName in params.events) {
            self2.bind(evtName, params.events[evtName]);
          }
        }
        this.clone = function() {
      ...
      var jsPlumbInstance = root2.jsPlumbInstance = function(_defaults) {
        ...
        this.bind = function(event2, fn) {
          if ("ready" === event2 && initialized) {
            fn();
          } else {
            _bb.apply(_currentInstance, [event2, fn]);
          }
        };
      ...
      _ju.extend(root2.jsPlumbInstance, _ju.EventGenerator, {
        ...
        registerConnectionType: function(id, type) {
          this._connectionTypes[id] = root2.jsPlumb.extend({}, type);
          if (type.overlays) {
            var to = {};
        ...
        registerEndpointType: function(id, type) {
          this._endpointTypes[id] = root2.jsPlumb.extend({}, type);
          if (type.overlays) {
            var to = {};
            for (var i = 0; i < type.overlays.length; i++) {
              var fo = this.convertToFullOverlaySpec(type.overlays[i]);
        ...
        proxyConnection: function(connection, index2, proxyEl, proxyElId, endpointGenerator, anchorGenerator) {
          var proxyEp, originalElementId = connection.endpoints[index2].elementId, originalEndpoint = connection.endpoints[index2];
          connection.proxies = connection.proxies || [];
          if (connection.proxies[index2]) {
            proxyEp = connection.proxies[index2].ep;
          } else {
            proxyEp = this.addEndpoint(proxyEl, {
              endpoint: endpointGenerator(connection, index2),
              anchor: anchorGenerator(connection, index2),
              parameters: {
          ...
          connection.proxies[index2] = { ep: proxyEp, originalEp: originalEndpoint };
          if (index2 === 0) {
          ...
          connection.endpoints[index2] = proxyEp;
          originalEndpoint.setVisible(false);
          connection.setVisible(true);
          this.revalidate(proxyEl);
        },
        unproxyConnection: function(connection, index2, proxyElId) {
          if (connection._jsPlumb == null || connection.proxies == null || connection.proxies[index2] == null) {
            return;
          }
          var originalElement = connection.proxies[index2].originalEp.element, originalElementId = connection.proxies[index2].originalEp.elementId;
          connection.endpoints[index2] = connection.proxies[index2].originalEp;
          if (index2 === 0) {
          ...
          connection.proxies[index2].ep.detachFromConnection(connection, null);
          connection.proxies[index2].originalEp.addConnection(connection);
          if (connection.isVisible()) {
            connection.proxies[index2].originalEp.setVisible(true);
          }
          delete connection.proxies[index2];
        }
      });
    ...
    (function() {
      ...
      _ju.extend(_jp.Connection, _jp.OverlayCapableJsPlumbUIComponent, {
        ...
        prepareEndpoint: function(_jsPlumb, _newEndpoint, conn, existing, index2, params, element, elementId, definition) {
          var e;
          if (existing) {
            conn.endpoints[index2] = existing;
            existing.addConnection(conn);
          } else {
            if (!params.endpoints) {
              params.endpoints = [null, null];
            }
            var ep = definition || params.endpoints[index2] || params.endpoint || _jsPlumb.Defaults.Endpoints[index2] || _jp.Defaults.Endpoints[index2] || _jsPlumb.Defaults.Endpoint || _jp.Defaults.Endpoint;
            ...
            var es = params.endpointStyles[index2] || params.endpointStyle || _jsPlumb.Defaults.EndpointStyles[index2] || _jp.Defaults.EndpointStyles[index2] || _jsPlumb.Defaults.EndpointStyle || _jp.Defaults.EndpointStyle;
            ...
            var ehs = params.endpointHoverStyles[index2] || params.endpointHoverStyle || _jsPlumb.Defaults.EndpointHoverStyles[index2] || _jp.Defaults.EndpointHoverStyles[index2] || _jsPlumb.Defaults.EndpointHoverStyle || _jp.Defaults.EndpointHoverStyle;
            ...
            var a = params.anchors ? params.anchors[index2] : params.anchor ? params.anchor : _makeAnchor(_jsPlumb.Defaults.Anchors[index2], elementId, _jsPlumb) || _makeAnchor(_jp.Defaults.Anchors[index2], elementId, _jsPlumb) || _makeAnchor(_jsPlumb.Defaults.Anchor, elementId, _jsPlumb) || _makeAnchor(_jp.Defaults.Anchor, elementId, _jsPlumb), u = params.uuids ? params.uuids[index2] : null;
            e = _newEndpoint({
              paintStyle: es,
              hoverPaintStyle: ehs,
              endpoint: ep,
    ...
    (function() {
      ...
      _jp.AnchorManager = function(params) {
        var _amEndpoints = {}, continuousAnchorLocations = {}, continuousAnchorOrientations = {}, connectionsByElementId = {}, self2 = this, anchorLists = {}, jsPlumbInstance = params.jsPlumbInstance, floatingConnections = {}, placeAnchorsOnLine = function(desc, elementDimensions, elementPosition, connections, horizontal, otherMultiplier, reverse, rotation) {
        ...
        this.connectionDetached = function(connInfo, doNotRedraw) {
          ...
          if (!doNotRedraw) {
            self2.redraw(connection.sourceId);
            if (connection.targetId !== connection.sourceId) {
              self2.redraw(connection.targetId);
            }
          }
        };
        ...
        this.rehomeEndpoint = function(ep, currentId, element) {
          ...
          if (elementId !== currentId) {
            ...
            if (idx > -1) {
              ...
              self2.add(_ep, elementId);
            }
          }
          for (var i = 0; i < ep.connections.length; i++) {
            if (ep.connections[i].sourceId === currentId) {
              self2.sourceOrTargetChanged(currentId, ep.elementId, ep.connections[i], ep.element, 0);
            } else if (ep.connections[i].targetId === currentId) {
              self2.sourceOrTargetChanged(currentId, ep.elementId, ep.connections[i], ep.element, 1);
            }
          }
        };
    ...
    (function() {
      ...
      _jp.Connectors.AbstractConnector = function(params) {
        ...
        var _prepareCompute = function(params2) {
          ...
          if (so[0] === 0 && so[1] === 0 || to[0] === 0 && to[1] === 0) {
            var index2 = w > h ? 0 : 1, oIndex = [1, 0][index2];
            so = [];
            to = [];
            so[index2] = params2.sourcePos[index2] > params2.targetPos[index2] ? -1 : 1;
            to[index2] = params2.sourcePos[index2] > params2.targetPos[index2] ? 1 : -1;
            so[oIndex] = 0;
            to[oIndex] = 0;
          }
      ...
      _jp.Endpoints.Triangle = function(params) {
        ...
        this._compute = function(anchorPoint, orientation, endpointStyle, connectorPaintStyle) {
          var width = endpointStyle.width || self2.width, height = endpointStyle.height || self2.height, x = anchorPoint[0] - width / 2, y = anchorPoint[1] - height / 2;
          return [x, y, width, height];
        };
      };
      ...
      _jp.Overlays.GuideLines = function() {
        ...
        this.draw = function(connector, currentConnectionPaintStyle) {
          var head = connector.pointAlongPathFrom(self2.loc, self2.length / 2), mid = connector.pointOnPath(self2.loc), tail = _jg.pointOnLine(head, mid, self2.length), tailLine = _jg.perpendicularLineTo(head, tail, 40), headLine = _jg.perpendicularLineTo(tail, head, 20);
          return {
            connector,
            head,
            tail,
    ...
    (function() {
      ...
      var GroupManager = function(_jsPlumb) {
        var _managedGroups = {}, _connectionSourceMap = {}, _connectionTargetMap = {}, self2 = this;
          ...
          if (group) {
            ...
            if (currentGroup !== group) {
              ...
              if (currentGroup != null) {
                ...
                self2.updateConnectionsForGroup(currentGroup);
              }
              group.add(el, doNotFireEvent);
              var handleDroppedConnections = function(list, index2) {
                var oidx = index2 === 0 ? 1 : 0;
                list.each(function(c) {
                  ...
                  if (c.endpoints[oidx].element._jsPlumbGroup === group) {
                    ...
                    c.endpoints[index2].setVisible(false);
                    _collapseConnection(c, index2, group);
                  }
                });
              };
              if (group.collapsed) {
              ...
              self2.updateConnectionsForGroup(group);
        ...
        this.removeFromGroup = function(group, el, doNotFireEvent) {
          ...
          if (group) {
            if (group.collapsed) {
              var _expandSet = function(conns, index2) {
                    ...
                    for (var j = 0; j < c.proxies.length; j++) {
                      if (c.proxies[j] != null) {
                        ...
                        if (proxiedElement === el || isDescendant(proxiedElement, el)) {
                          _expandConnection(c, index2, group);
                        }
                      }
                    }
                  }
        ...
        var _collapseConnection = function(c, index2, group) {
          var otherEl = c.endpoints[index2 === 0 ? 1 : 0].element;
          ...
          _jsPlumb.proxyConnection(c, index2, groupEl, groupElId, function(c2, index3) {
            return group.getEndpoint(c2, index3);
          }, function(c2, index3) {
            return group.getAnchor(c2, index3);
          });
        };
        this.collapseGroup = function(group) {
          ...
          if (group.shouldProxy()) {
            var _collapseSet = function(conns, index2) {
              for (var i = 0; i < conns.length; i++) {
                var c = conns[i];
                _collapseConnection(c, index2, group);
              }
        ...
        var _expandConnection = function(c, index2, group) {
          _jsPlumb.unproxyConnection(c, index2, _jsPlumb.getId(group.getEl()));
        };
      ...
      var Group = function(_jsPlumb, params) {
        ...
        if (params.draggable !== false) {
          var opts = {
            ...
            stop: function(params2) {
              _jsPlumb.fire(EVT_GROUP_DRAG_STOP, jsPlumb.extend(params2, { group: self2 }));
            },
        ...
        if (params.droppable !== false) {
          _jsPlumb.droppable(params.el, {
            drop: function(p) {
              ...
              if (currentGroup !== self2) {
                if (currentGroup != null) {
                  if (currentGroup.overrideDrop(el2, self2)) {
                    return;
                  }
                }
                _jsPlumb.getGroupManager().addToGroup(self2, el2, false);
              }
            }
          });
        }
        ...
        this.add = function(_el, doNotFireEvent) {
          ...
          _jsPlumb.getGroupManager().updateConnectionsForGroup(self2);
        };
        this.remove = function(el2, manipulateDOM, doNotFireEvent, doNotUpdateConnections, targetGroup) {
          _each(el2, function(__el) {
            if (__el._jsPlumbGroup === self2) {
              ...
              if (manipulateDOM) {
                try {
                  self2.getDragArea().removeChild(__el);
                } catch (e) {
        ...
        this.removeAll = function(manipulateDOM, doNotFireEvent) {
          for (var i = 0, l = elements.length; i < l; i++) {
            var el2 = elements[0];
            self2.remove(el2, manipulateDOM, doNotFireEvent, true);
    ...
    (function() {
      ...
      _jp.ConnectorRenderers.svg = function(params) {
        var self2 = this, _super = SvgComponent.apply(this, [
          {
        ...
        _super.renderer.paint = function(style, anchor, extents) {
          var segments = self2.getSegments(), p = "", offset = [0, 0];
          if (extents.xmin < 0) {
          ...
          if (segments.length > 0) {
            ...
            }, outlineStyle = null, d = [self2.x, self2.y, self2.w, self2.h];
            if (style.outlineStroke) {
              ...
              if (self2.bgPath == null) {
                self2.bgPath = _node("path", a);
                _jp.addClass(self2.bgPath, _jp.connectorOutlineClass);
                _appendAtIndex(self2.svg, self2.bgPath, 0);
              } else {
                _attr(self2.bgPath, a);
              }
              _applyStyles(self2.svg, self2.bgPath, outlineStyle, d, self2);
            }
            if (self2.path == null) {
              self2.path = _node("path", a);
              _appendAtIndex(self2.svg, self2.path, style.outlineStroke ? 1 : 0);
            } else {
              _attr(self2.path, a);
            }
            _applyStyles(self2.svg, self2.path, style, d, self2);
          }
        };
      };
      ...
      _jp.Overlays.svg.GuideLines = function() {
        var path = null, self2 = this, p1_1, p1_2;
        _jp.Overlays.GuideLines.apply(this, arguments);
        this.paint = function(params, containerExtents) {
          if (path == null) {
            path = _node("path");
            params.connector.svg.appendChild(path);
            self2.attachListeners(path, params.connector);
            self2.attachListeners(path, self2);
            p1_1 = _node("path");
            params.connector.svg.appendChild(p1_1);
            self2.attachListeners(p1_1, params.connector);
            self2.attachListeners(p1_1, self2);
            p1_2 = _node("path");
            params.connector.svg.appendChild(p1_2);
            self2.attachListeners(p1_2, params.connector);
            self2.attachListeners(p1_2, self2);
          }
          var offset = [0, 0];
          if (containerExtents.xmin < 0) {
            offset[0] = -containerExtents.xmin;
    ...
    (function() {
      ...
      root2.jsPlumb.extend(root2.jsPlumbInstance.prototype, {
        ...
        trigger: function(el, event2, originalEvent, payload) {
          this.getEventManager().trigger(el, event2, originalEvent, payload);
        },
        doReset: function() {
          for (var key in this) {
        ...
        on: function(el, event2, callback) {
          this.getEventManager().on.apply(this, arguments);
          return this;
        },
        off: function(el, event2, callback) {
  ...
  function getPreNodes(nodeId, rest) {
    const { flowData } = rest;
  ...
  function install$1(global2) {
    return {
      getPreNodes: (nodeId) => getPreNodes(nodeId, global2),
      clear: () => clear(global2),
      setStatus: (id, status, message) => setStatus(id, status, message, global2)
    };
  }
  function clear(rest) {
    const { flowData, plumb } = rest;
    vue.unref(flowData).nodeList.forEach((node) => {
      vue.unref(plumb).remove(node.id);
    });
    vue.unref(flowData).nodeList = [];
    vue.unref(flowData).linkList = [];
  }
  function setStatus(id, status, message, rest) {
    const { plumb } = rest;
    vue.unref(plumb).setAttributes(document.getElementById(id), { status, message });
  }
  const getEndpointUUID = (nodeId, type, outputIndex) => {
  ...
  function __addOutputEndpoints(node) {
    let index2;
    const indexData = {};
    return node.outputs.map((inputName, i) => {
      if (indexData.hasOwnProperty(inputName)) {
        indexData[inputName]++;
      } else {
        indexData[inputName] = 0;
      ...
      const newEndpointData = {
        uuid: getEndpointUUID(node.id, "output", index2),
        parameters: {
          endpoint: inputName
        },
        anchor: anchorPosition,
  ...
  function __addNode(instance, node) {
    const { flowType } = node;
    let input = [];
    let output = [];
  ...
  function __addLink(instance, source, target, parameters) {
    ...
    sourceEndpoints.forEach((item) => {
      var _a;
      if (((_a = item.getParameters()) == null ? void 0 : _a.endpoint) === source.endpoint) {
        sourceEndpoint = item;
      }
    });
    targetEndpoints.forEach((item) => {
      var _a;
      if (((_a = item.getParameters()) == null ? void 0 : _a.endpoint) === target.endpoint) {
        targetEndpoint = item;
      }
    });
  ...
  (function(module2) {
    module2.exports = normalizeWheel_1;
  })(normalizeWheel$2);
  const normalizeWheel = /* @__PURE__ */ getDefaultExportFromCjs(normalizeWheel$2.exports);
  const _sfc_main = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const plumb = vue.ref();
      vue.ref(false);
      const status = vue.ref("3");
      const flowConfig$1 = vue.ref(flowConfig);
      const flowData = vue.computed(() => {
        return props2.data;
      });
      vue.watch(
        () => props2.data,
      ...
      const container = vue.reactive({
        ...
        dragFlag: false,
        draging: false,
        scale: flowConfig$1.value.defaultStyle.containerScale.init,
        scaleFlag: false,
        scaleOrigin: {
          x: 0,
          y: 0
        ...
        auxiliaryLine: {
          isOpen: flowConfig$1.value.defaultStyle.isOpenAuxiliaryLine,
          isShowXLine: false,
          isShowYLine: false,
          controlFnTimesFlag: true
        }
      });
      const auxiliaryLinePos = vue.reactive({
        x: 0,
        y: 0
      });
      ...
      const rectangleMultiple = vue.reactive({
        flag: true,
        multipling: false,
        position: {
          top: 0,
      ...
      function handleDrop(event2) {
        if (props2.readOnly)
          return;
        let dragInfo = event2.dataTransfer.getData("dragInfo");
        addNewNode(JSON.parse(dragInfo));
      }
      function mousemoveHandler(e) {
        var _a;
        const canvasRect = (_a = document.getElementById("flowContainer")) == null ? void 0 : _a.getBoundingClientRect();
        if (!canvasRect) {
          return;
        }
      ...
      function computeNodePos(x, y) {
        const pxx = flowConfig$1.value.defaultStyle.alignGridPX[0];
        const pxy = flowConfig$1.value.defaultStyle.alignGridPX[1];
        if (x % pxx)
          x = pxx - x % pxx + x;
        if (y % pxy)
          y = pxy - y % pxy + y;
      ...
      function addNewNode(node) {
        ...
        vue.unref(flowData).nodeList.push(newNode);
        vue.nextTick(() => {
          __addNode(plumb.value, newNode);
          emits("update:data", vue.unref(flowData));
      ...
      function judgeSelectedNode() {
        ...
        let nodeList = vue.unref(flowData).nodeList;
        nodeList.forEach((node) => {
          if (node.y + halfNodeWidth >= ay && node.x + halfNodeWidth >= ax && node.y + halfNodeWidth <= by && node.x + halfNodeWidth <= bx) {
            plumb.value.addToDragSelection(node.id);
            vue.unref(currentSelectGroup).push(node);
          }
        });
      }
      ...
      function zoomFit() {
        var _a;
        const nodeList = ((_a = vue.unref(flowData)) == null ? void 0 : _a.nodeList) || [];
        if (!nodeList.length) {
          return;
        }
      ...
      function flowInfo() {
        let nodeList = vue.unref(flowData).nodeList;
        let linkList = vue.unref(flowData).linkList;
        console.info(
      ...
      function copyNode() {
        clipboard = [];
        if (vue.unref(currentSelectGroup).length > 0) {
          clipboard = Object.assign([], vue.unref(currentSelectGroup));
        } else if (vue.unref(currentSelect).id) {
          clipboard.push(vue.unref(currentSelect));
        }
      }
      ...
      function deleteNode(nodes) {
        let nodeList = vue.unref(flowData).nodeList;
        let linkList = vue.unref(flowData).linkList;
        let arr = Array.isArray(nodes) ? nodes : [nodes];
        ...
        arr.forEach((c) => {
          ...
          (plumb.value.getEndpoints(c.id) || []).flat().forEach((endpoint) => {
            var _a;
            return (_a = plumb.value) == null ? void 0 : _a.deleteEndpoint(endpoint);
          });
      ...
      function updateNodePos() {
        let nodeList = vue.unref(flowData).nodeList;
        vue.unref(currentSelectGroup).forEach((node) => {
          var _a, _b;
          let dom = document.querySelector("#" + node.id);
          let l = parseInt((_a = dom == null ? void 0 : dom.style) == null ? void 0 : _a.left);
          let t = parseInt((_b = dom == null ? void 0 : dom.style) == null ? void 0 : _b.top);
      ...
      function updateNodeDisable(node) {
        let { disabled } = node;
        let nodeList = vue.unref(flowData).nodeList;
        let current = nodeList.find((n) => n.id === node.id);
        current.disabled = !disabled;
      }
      function alignForLine(e) {
        if (vue.unref(currentSelectGroup).length > 1)
          return;
        if (container.auxiliaryLine.controlFnTimesFlag) {
          ...
          nodeList.forEach((node) => {
            if (elId !== node.id) {
              ...
              let dis = flowConfig$1.value.defaultStyle.showAuxiliaryLineDistance, elPos = e.pos, elH = e.el.offsetHeight, elW = e.el.offsetWidth, disX = elPos[0] - node.x, disY = elPos[1] - node.y;
      ...
      function initJsPlumb() {
        plumb.value = jsplumb.jsPlumb.getInstance(vue.unref(flowConfig$1).jsPlumbInsConfig);
        vue.unref(plumb).bind("beforeDrop", (info) => {
        ...
        vue.unref(plumb).bind("connection", (conn) => {
          var _a, _b, _c, _d, _e;
          ...
          o.cls = {
            linkType: (_a = vue.unref(flowConfig$1).jsPlumbInsConfig.Connector) == null ? void 0 : _a[0],
            linkColor: (_b = vue.unref(flowConfig$1).jsPlumbInsConfig.PaintStyle) == null ? void 0 : _b.stroke,
            linkThickness: (_c = vue.unref(flowConfig$1).jsPlumbInsConfig.PaintStyle) == null ? void 0 : _c.strokeWidth
          };
          (_d = document.querySelector("#" + id)) == null ? void 0 : _d.addEventListener("contextmenu", (e) => {
            showLinkContextMenu(e);
            currentSelect.value = flowData.value.linkList.find((l) => l.id === id);
          });
          (_e = document.querySelector("#" + id)) == null ? void 0 : _e.addEventListener("click", (e) => {
            e.stopPropagation();
            currentSelect.value = flowData.value.linkList.find((l) => l.id === id);
          });
        ...
        vue.unref(plumb).importDefaults({
          ConnectionsDetachable: vue.unref(flowConfig$1).jsPlumbConfig.conn.isDetachable
        });
      }
      function dataInit() {
        if (!vue.unref(plumb))
        ...
        setTimeout(() => {
          setReadOnly(props2.readOnly);
        });
      }
      function setReadOnly(flag) {
        if (!vue.unref(plumb))
          return;
        vue.unref(plumb).setSuspendDrawing(flag);
        const connections = vue.unref(plumb).getAllConnections();
        connections.forEach((connection) => {
          connection.setDetachable(!flag);
        });
        const nodes = vue.unref(flowData).nodeList || [];
        nodes.forEach((node) => {
          vue.unref(plumb).setDraggable(document.getElementById(node.id), !flag);
        });
      }
      ...
      function moveWorkflow(e) {
        const normalized = normalizeWheel(e);
        const nodeViewOffsetPositionX = container.pos.left - (e.shiftKey ? normalized.pixelY : normalized.pixelX);
        const nodeViewOffsetPositionY = container.pos.top - (e.shiftKey ? normalized.pixelX : normalized.pixelY);
        container.pos = {
      ...
      function deleteLink() {
        var _a, _b;
        let sourceId = (_a = vue.unref(currentSelect)) == null ? void 0 : _a.sourceId;
        let targetId = (_b = vue.unref(currentSelect)) == null ? void 0 : _b.targetId;
        vue.unref(plumb).deleteConnection(
          vue.unref(plumb).getConnections({
            source: sourceId,
            target: targetId
          })[0]
        );
      ...
      vue.watch(
        ...
        (val) => {
          ...
          currentSelect.value = val;
          if (tempLinkId !== "") {
            (_a = document.querySelector("#" + tempLinkId)) == null ? void 0 : _a.classList.remove("link-active");
            tempLinkId = "";
          }
          if (vue.unref(currentSelect).type === "link") {
            tempLinkId = vue.unref(currentSelect).id;
            (_b = document.querySelector("#" + vue.unref(currentSelect).id)) == null ? void 0 : _b.classList.add("link-active");
          }
        },
        { deep: true }
      );
      ...
      vue.watch(
        ...
        (val) => {
          currentSelectGroup.value = val;
          if (vue.unref(currentSelectGroup).length <= 0)
            plumb.value.clearDragSelection();
        }
      );
      vue.watch(
        () => currentSelectGroup.value,
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          container.auxiliaryLine.isOpen && container.auxiliaryLine.isShowXLine ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 0,
            class: "flow-area__lineX",
            style: vue.normalizeStyle({ top: auxiliaryLinePos.y + "px" })
          }, null, 4)) : vue.createCommentVNode("", true),
          container.auxiliaryLine.isOpen && container.auxiliaryLine.isShowYLine ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 1,
            class: "flow-area__lineY",
            style: vue.normalizeStyle({ left: auxiliaryLinePos.x + "px" })
          }, null, 4)) : vue.createCommentVNode("", true),
          vue.createElementVNode("div", {
            id: "flowContainer",
            class: vue.normalizeClass(["flow-area__container", {
              grid: flowConfig$1.value.defaultStyle.showGrid,
            ...
            onMousewheel: scaleContainer,
            onDOMMouseScroll: scaleContainer,
            onContextmenu: showContainerContextMenu
          }, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(flowData).nodeList, (node) => {
              return vue.openBlock(), vue.createBlock(_sfc_main$2, {
                key: node.id,
                node,
                plumb: plumb.value,
                config: flowConfig$1.value,
                select: currentSelect.value,
                "onUpdate:select": _cache[0] || (_cache[0] = ($event) => currentSelect.value = $event),
                selectGroup: currentSelectGroup.value,
                "onUpdate:selectGroup": _cache[1] || (_cache[1] = ($event) => currentSelectGroup.value = $event),
                onShowNodeContextMenu: showNodeContextMenu,
                onIsMultiple: isMultiple,
                onUpdateNodePos: updateNodePos,
                onUpdateNodeDisable: updateNodeDisable,
                onNodeDelete: deleteNode,
                onSetNodeParams: _cache[2] || (_cache[2] = (v) => emits("setNodeParams", v)),
                onAlignForLine: alignForLine,
                onHideAlignLine: hideAlignLine
              }, null, 8, ["node", "plumb", "config", "select", "selectGroup"]);
            }), 128)),
            rectangleMultiple.flag && rectangleMultiple.multipling && rectangleMultiple.width && rectangleMultiple.height ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 0,
  ...
  const index = "";
  const install = (Vue) => {
    Vue.component("FlowArea", _sfc_main);
  };
  exports2.default = install;
  exports2.flowArea = _sfc_main;
  exports2.flowConfig = flowConfig;
