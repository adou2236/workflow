...
(function(global2, factory) {
  ...
  const _sfc_main = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const flowData = vue.ref(props2.data);
      const currentSelect = vue.ref(props2.select);
      const currentSelectGroup = vue.ref(props2.selectGroup);
      ...
      function zoomFit() {
        const nodeList = vue.unref(flowData).nodeList;
        if (!nodeList.length) {
          return;
        }
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          vue.createElementVNode("div", {
            ...
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(flowData.value.nodeList, (node) => {
