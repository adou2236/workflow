...
import { defineComponent, reactive, ref, watch, nextTick, onMounted, onBeforeUnmount, resolveComponent, openBlock, createElementBlock, normalizeClass, normalizeStyle, withModifiers, withDirectives, createElementVNode, createVNode, withCtx, createBlock, resolveDynamicComponent, vShow, toDisplayString, unref, computed, onUnmounted, isVNode, Fragment, render, getCurrentInstance, createCommentVNode, renderList } from "vue";
...
const _hoisted_6 = /* @__PURE__ */ createElementVNode("div", { class: "node-anchor node-anchor__top" }, null, -1);
const _hoisted_7 = /* @__PURE__ */ createElementVNode("div", { class: "node-anchor node-anchor__right" }, null, -1);
const _hoisted_8 = /* @__PURE__ */ createElementVNode("div", { class: "node-anchor node-anchor__bottom" }, null, -1);
const _hoisted_9 = /* @__PURE__ */ createElementVNode("div", { class: "node-anchor node-anchor__left" }, null, -1);
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        onContextmenu: _cache[0] || (_cache[0] = withModifiers(($event) => showNodeContextMenu(__props.node), ["stop"])),
        ...
        createElementVNode("div", _hoisted_3, [
          createElementVNode("div", {
            ...
            createElementVNode("p", _hoisted_5, toDisplayString(__props.node.displayName), 1)
          ], 8, _hoisted_4)
        ]),
        _hoisted_6,
        _hoisted_7,
