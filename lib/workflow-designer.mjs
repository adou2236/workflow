...
import { openBlock, createElementBlock, createElementVNode, defineComponent, reactive, ref, watch, nextTick, onMounted, resolveComponent, normalizeClass, normalizeStyle, withModifiers, createVNode, withCtx, createBlock, unref, resolveDynamicComponent, toDisplayString, createCommentVNode, computed, onUnmounted, isVNode, Fragment, render, getCurrentInstance, renderList } from "vue";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    watch(() => props2.select, (val) => {
      currentSelect.value = val;
    }, { deep: true });
    watch(() => currentSelect.value, (currentSelect2) => {
      emits("update:select", currentSelect2);
    });
    watch(() => props2.selectGroup, (val) => {
      currentSelectGroup.value = val;
    });
    watch(() => currentSelectGroup.value, (currentSelectGroup2) => {
      emits("update:selectGroup", currentSelectGroup2);
    });
    watch(() => props2.plumb, (v) => {
      if (v) {
        nextTick(() => {
          registerNode();
        });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", _hoisted_4, [
          (openBlock(), createBlock(resolveDynamicComponent(__props.node.icon)))
        ]),
        createElementVNode("div", _hoisted_5, [
          createElementVNode("div", {
            ...
            createElementVNode("p", _hoisted_7, toDisplayString(__props.node.displayName), 1),
            __props.node.disabled ? (openBlock(), createElementBlock("p", _hoisted_8, "(\u7981\u7528)")) : createCommentVNode("", true)
          ], 8, _hoisted_6)
        ])
      ], 46, _hoisted_1$1);
    };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit: emits }) {
    ...
    const plumb = ref();
    const status = ref();
    const flowConfig$1 = reactive(props2.config || flowConfig);
    const flowData = ref(props2.data);
    const currentSelect = ref(props2.select);
    const currentSelectGroup = ref(props2.selectGroup);
    ...
    function deleteLink() {
      ...
      unref(plumb).deleteConnection(unref(plumb).getConnections({
        source: sourceId,
        target: targetId
      })[0]);
      let linkList = unref(flowData).linkList;
    ...
    watch(() => currentSelectGroup.value, (val) => {
      emits("update:selectGroup", val);
    }, { deep: true });
    watch(() => props2.readOnly, (v) => {
    });
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(flowData.value.nodeList, (node) => {
          ...
          rectangleMultiple.flag && rectangleMultiple.multipling ? (openBlock(), createElementBlock("div", {
            key: 0,
        ...
        createElementVNode("div", _hoisted_1, [
          ...
          createElementVNode("span", null, toDisplayString(container.scaleShow) + "% ", 1),
          createVNode(_component_el_button, {
            size: "small",
            type: "default",
