...
import { openBlock, createElementBlock, createElementVNode, defineComponent, reactive, ref, watch, nextTick, onMounted, onBeforeUnmount, resolveComponent, normalizeClass, normalizeStyle, withModifiers, createVNode, withCtx, createBlock, unref, withDirectives, resolveDynamicComponent, vShow, toDisplayString, createCommentVNode, computed, onUnmounted, isVNode, Fragment, render, getCurrentInstance, renderList } from "vue";
...
}, _hoisted_2282 = /* @__PURE__ */ createElementVNode(
  "path",
  {
    fill: "currentColor",
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const flowConfig2 = reactive(props2.config);
    const currentNode = reactive(props2.node);
    const currentSelect = ref(props2.select);
    const currentSelectGroup = ref(props2.selectGroup);
    const nodeRef = ref();
    const message = ref("");
    const status = ref("");
    const IconMap = ref({
    ...
    function isActive() {
      ...
      if (unref(currentSelect).id === currentNode.id)
        return true;
    ...
    return (_ctx, _cache) => {
      const _component_VideoPause = resolveComponent("VideoPause");
      ...
      return openBlock(), createElementBlock("div", {
        ...
        onClick: withModifiers(selectNode, ["stop"]),
        onContextmenu: _cache[3] || (_cache[3] = withModifiers(($event) => showNodeContextMenu(__props.node), ["stop"]))
      }, [
        createElementVNode("div", _hoisted_2, [
          createVNode(_component_el_icon, {
            ...
            default: withCtx(() => [
              __props.node.disabled ? (openBlock(), createBlock(unref(video_play_default), { key: 0 })) : (openBlock(), createBlock(_component_VideoPause, { key: 1 }))
            ]),
            _: 1
          }),
          createVNode(_component_el_icon, {
        ...
        withDirectives(createElementVNode("div", _hoisted_3, [
          createVNode(_component_el_tooltip, { content: message.value }, {
            default: withCtx(() => [
              createVNode(_component_el_icon, {
                color: `var(--el-color-${status.value})`
              }, {
                default: withCtx(() => [
                  (openBlock(), createBlock(resolveDynamicComponent(IconMap.value[status.value])))
                ]),
                _: 1
              }, 8, ["color"])
            ]),
        ...
        createElementVNode("div", _hoisted_6, [
          createElementVNode("div", {
            ...
            createElementVNode("p", _hoisted_8, toDisplayString(__props.node.displayName), 1),
            __props.node.disabled ? (openBlock(), createElementBlock("p", _hoisted_9, "(\u7981\u7528)")) : createCommentVNode("", true)
          ], 8, _hoisted_7)
        ])
      ], 46, _hoisted_1);
    };
    ...
    function renderMenuItem(items) {
      ...
      return visibleItems.map((item) => {
        ...
        if (!children || children.length === 0) {
          return createVNode(Fragment, null, [createVNode(resolveComponent("el-menu-item"), {
            "disabled": disabled,
            "class": `${prefixCls}__item`,
            "key": label
          }, {
            default: () => [createVNode(ItemContent, contentProps, null)]
          }), divider ? createVNode(resolveComponent("el-divider"), {
            "key": `d-${label}`
          }, null) : null]);
        }
        if (!unref(showRef))
...
(function(exports) {
  ...
  (function() {
    ...
    _jp.FloatingAnchor = function(params) {
      ...
      var ref2 = params.reference, refCanvas = params.referenceCanvas, size = _jp.getSize(refCanvas), xDir = 0, yDir = 0, orientation = null, _lastResult = null;
      ...
      this.getOrientation = function(_endpoint) {
        if (orientation) {
          ...
          var o = ref2.getOrientation(_endpoint);
          return [
            Math.abs(o[0]) * xDir * -1,
            Math.abs(o[1]) * yDir * -1
          ];
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit: emits }) {
    ...
    ref(false);
    const status = ref("3");
    const flowConfig$1 = ref(flowConfig);
    ...
    function zoomFit() {
      var _a;
      const nodeList = ((_a = unref(flowData)) == null ? void 0 : _a.nodeList) || [];
      if (!nodeList.length) {
        return;
      }
    ...
    function copyNode() {
      ...
      if (unref(currentSelectGroup).length > 0) {
        ...
        clipboard.push(unref(currentSelect));
      }
    }
    ...
    function initJsPlumb() {
      plumb.value = jsplumb.jsPlumb.getInstance(unref(flowConfig$1).jsPlumbInsConfig);
      unref(plumb).bind("beforeDrop", (info) => {
      ...
      unref(plumb).bind("connection", (conn) => {
        var _a, _b, _c, _d, _e;
        ...
        o.cls = {
          linkType: (_a = unref(flowConfig$1).jsPlumbInsConfig.Connector) == null ? void 0 : _a[0],
          linkColor: (_b = unref(flowConfig$1).jsPlumbInsConfig.PaintStyle) == null ? void 0 : _b.stroke,
          linkThickness: (_c = unref(flowConfig$1).jsPlumbInsConfig.PaintStyle) == null ? void 0 : _c.strokeWidth
        };
      ...
      unref(plumb).importDefaults({
        ConnectionsDetachable: unref(flowConfig$1).jsPlumbConfig.conn.isDetachable
      });
    }
    function dataInit() {
      if (!unref(plumb))
    ...
    function deleteLink() {
      var _a, _b;
      let sourceId = (_a = unref(currentSelect)) == null ? void 0 : _a.sourceId;
      let targetId = (_b = unref(currentSelect)) == null ? void 0 : _b.targetId;
    ...
    watch(
      ...
      (val) => {
        ...
        if (unref(currentSelect).type === "link") {
          ...
          (_b = document.querySelector("#" + unref(currentSelect).id)) == null ? void 0 : _b.classList.add("link-active");
        }
      },
      { deep: true }
    );
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        container.auxiliaryLine.isOpen && container.auxiliaryLine.isShowXLine ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "flow-area__lineX",
          style: normalizeStyle({ top: auxiliaryLinePos.y + "px" })
        }, null, 4)) : createCommentVNode("", true),
        container.auxiliaryLine.isOpen && container.auxiliaryLine.isShowYLine ? (openBlock(), createElementBlock("div", {
          key: 1,
          class: "flow-area__lineY",
          style: normalizeStyle({ left: auxiliaryLinePos.x + "px" })
        }, null, 4)) : createCommentVNode("", true),
        createElementVNode("div", {
          id: "flowContainer",
          class: normalizeClass(["flow-area__container", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(flowData).nodeList, (node) => {
          ...
          rectangleMultiple.flag && rectangleMultiple.multipling && rectangleMultiple.width && rectangleMultiple.height ? (openBlock(), createElementBlock("div", {
            key: 0,
