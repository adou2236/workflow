  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      function renderMenuItem(items: ContextMenuItem[]) {
        ...
        return visibleItems.map((item) => {
          ...
          if (!children || children.length === 0) {
            return (
              <>
                <el-menu-item disabled={disabled} class={`${prefixCls}__item`} key={label}>
          ...
          return (
            <el-sub-menu key={label} disabled={disabled} popupClassName={`${prefixCls}__popup`}>
              {{
      ...
      return () => {
        ...
        return (
          <div class={prefixCls}>
            <el-menu inlineIndent={12} mode="vertical" ref={wrapRef} style={unref(getStyle)}>
