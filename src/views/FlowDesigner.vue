...
<script lang="ts" setup>
  ...
  onMounted(() => {
    flowAreaRef.value.setStatus('common-74f27436a41f44bcb09eaf57a6019149', 'error', 'asdasd');
    flowAreaRef.value.setStatus('common-c56770095aee4e0581d321230428866d', 'warning', 'warning');
    flowAreaRef.value.setStatus('common-d0947d7784674bb19d33c59d8368b59e', 'info', 'info');
    flowAreaRef.value.setStatus('common-21657bad7c00400a8c829ff044e3ca30', 'success', 'success');
  });
</script>
